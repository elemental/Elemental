...
if(ELEM_HAVE_PDPOTRF)
  ...
  if(NOT ELEM_HAVE_PDLAQR0 OR NOT ELEM_HAVE_PDLAQR1)
    message(STATUS "ScaLAPACK version was too old to support PDLAQR{0,1}.")
...
elseif(ELEM_HAVE_PDPOTRF_POST)
  ...
  if(NOT ELEM_HAVE_PDLAQR0_POST OR NOT ELEM_HAVE_PDLAQR1_POST)
    message(STATUS "ScaLAPACK version was too old to support PDLAQR{0,1}.")
  else()
    set(ELEM_HAVE_SCALAPACK TRUE)
  endif()
