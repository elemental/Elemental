...
set(MPI_C_INCLUDE_PATH       /opt/apps/intel15/mvapich2/2.1/include)
set(MPI_CXX_INCLUDE_PATH     ${MPI_C_INCLUDE_PATH})
set(MPI_Fortran_INCLUDE_PATH ${MPI_C_INCLUDE_PATH})
set(MPI_LINK_FLAGS "-Wl,-rpath,/opt/apps/limic2/0.5.5/lib -L/opt/apps/limic2/0.5.5/lib -L/opt/apps/intel15/mvapich2/2.1/lib -L/opt/ofed/lib64/")
set(MPI_BASE_LIBS 
