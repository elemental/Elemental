...
set(MPI_C_LIBRARIES "-lmpich -lopa -lmpl -ldl -lpami -lSPI -lSPI_cnk -lpthread -lrt")
set(MPI_CXX_LIBRARIES "-lcxxmpich ${MPI_C_LIBRARIES} -lstdc++")
...
set(BLAS_FLAGS "-L${BLAS_LIB} -lblas")
...
set(MATH_LIBS "${LAPACK_FLAGS} ${BLAS_FLAGS} ${XLF_FLAGS} ${XLSMP_FLAGS} -lxlopt -lxlfmath -lxl -lgfortran -lm -lpthread -ldl")
