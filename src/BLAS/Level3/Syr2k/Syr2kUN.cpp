...
template<typename T>
void
Elemental::BLAS::Internal::Syr2kUNUpdate
...
{
#ifndef RELEASE
    PushCallStack("BLAS::Internal::Syr2kUNUpdate");
#endif
        ...
        B_MC_Star.Width()  != B_MR_Star.Width()    )
    {
        if( grid.VCRank() == 0 )
        {
            cerr << "Nonconformal Syr2kUNUpdate: " <<
...
template void Elemental::BLAS::Internal::Syr2kUNUpdate
