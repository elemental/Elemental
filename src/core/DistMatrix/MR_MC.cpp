...
// =============
template<typename T>
mpi::Comm DM::DistComm() const EL_NOEXCEPT { return this->grid_->VRComm(); }
template<typename T>
...
template<typename T>
mpi::Comm DM::ColComm() const EL_NOEXCEPT { return this->grid_->MRComm(); }
template<typename T>
mpi::Comm DM::RowComm() const EL_NOEXCEPT { return this->grid_->MCComm(); }

template<typename T>
int DM::ColStride() const EL_NOEXCEPT { return this->grid_->MRSize(); }
template<typename T>
int DM::RowStride() const EL_NOEXCEPT { return this->grid_->MCSize(); }
template<typename T>
int DM::DistSize() const EL_NOEXCEPT { return this->grid_->VRSize(); }
template<typename T>
