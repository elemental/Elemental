...
template<typename T>
mpi::Comm BDM::CrossComm() const EL_NO_EXCEPT { return ( this->Participating() ? mpi::COMM_SELF : mpi::COMM_NULL ); }
template<typename T>
mpi::Comm BDM::RedundantComm() const EL_NO_EXCEPT { return ( this->Participating() ? mpi::COMM_SELF : mpi::COMM_NULL ); }
template<typename T>
