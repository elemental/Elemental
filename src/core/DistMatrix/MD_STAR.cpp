...
template<typename T>
int DM::ColStride() const EL_NOEXCEPT { return this->grid_->LCM(); }
template<typename T>
int DM::RowStride() const EL_NOEXCEPT { return 1; }
template<typename T>
int DM::DistSize() const EL_NOEXCEPT { return this->grid_->LCM(); }
template<typename T>
int DM::CrossSize() const EL_NOEXCEPT { return this->grid_->GCD(); }
template<typename T>
