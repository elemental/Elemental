...
// =============
template<typename T>
mpi::Comm DM::DistComm() const EL_NO_EXCEPT { return mpi::COMM_SELF; }
template<typename T>
mpi::Comm DM::RedundantComm() const EL_NO_EXCEPT { return mpi::COMM_SELF; }
template<typename T>
mpi::Comm DM::CrossComm() const EL_NO_EXCEPT { return this->grid_->VCComm(); }
template<typename T>
mpi::Comm DM::ColComm() const EL_NO_EXCEPT { return mpi::COMM_SELF; }
template<typename T>
mpi::Comm DM::RowComm() const EL_NO_EXCEPT { return mpi::COMM_SELF; }
