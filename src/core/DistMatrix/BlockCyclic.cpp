...
template<typename T>
BlockCyclicMatrix<T>::BlockCyclicMatrix
...
template<typename T>
BlockCyclicMatrix<T>::BlockCyclicMatrix
( BlockCyclicMatrix<T>&& A ) EL_NO_EXCEPT
...
template<typename T>
BlockCyclicMatrix<T>& 
BlockCyclicMatrix<T>::operator=( BlockCyclicMatrix<T>&& A )
{
...
template<typename T>
void BlockCyclicMatrix<T>::Empty()
{
    this->matrix_.Empty_();
...
template<typename T>
void BlockCyclicMatrix<T>::Resize( Int height, Int width )
{
    DEBUG_ONLY(
      CSE cse("BCM::Resize");
...
template<typename T>
void BlockCyclicMatrix<T>::Resize( Int height, Int width, Int ldim )
{
    DEBUG_ONLY(
      CSE cse("BCM::Resize");
      this->AssertNotLocked();
...
template<typename T>
void BlockCyclicMatrix<T>::MakeConsistent( bool includingViewers )
{
...
template<typename T>
void BlockCyclicMatrix<T>::Align
...
template<typename T>
void BlockCyclicMatrix<T>::AlignCols
...
template<typename T>
void BlockCyclicMatrix<T>::AlignRows
...
template<typename T>
void BlockCyclicMatrix<T>::AlignWith
...
template<typename T>
void BlockCyclicMatrix<T>::AlignAndResize
( Int blockHeight, Int blockWidth, 
...
template<typename T>
void BlockCyclicMatrix<T>::AlignColsAndResize
...
template<typename T>
void BlockCyclicMatrix<T>::AlignRowsAndResize
...
template<typename T>
void BlockCyclicMatrix<T>::Attach
...
template<typename T>
void BlockCyclicMatrix<T>::LockedAttach
( Int height, Int width, const El::Grid& g, 
  Int blockHeight, Int blockWidth, 
  int colAlign, int rowAlign, Int colCut, Int rowCut,
...
template<typename T>
Int BlockCyclicMatrix<T>::BlockHeight() const EL_NO_EXCEPT
{ return this->blockHeight_; }
template<typename T>
Int BlockCyclicMatrix<T>::BlockWidth() const EL_NO_EXCEPT
{ return this->blockWidth_; }

template<typename T>
Int BlockCyclicMatrix<T>::ColCut() const EL_NO_EXCEPT
{ return this->colCut_; }
template<typename T>
Int BlockCyclicMatrix<T>::RowCut() const EL_NO_EXCEPT
{ return this->rowCut_; }

template<typename T>
int BlockCyclicMatrix<T>::RowOwner( Int i ) const EL_NO_EXCEPT
{ 
...
template<typename T>
int BlockCyclicMatrix<T>::ColOwner( Int j ) const EL_NO_EXCEPT
{ 
...
template<typename T>
Int BlockCyclicMatrix<T>::LocalRowOffset( Int i ) const EL_NO_EXCEPT
{ 
    if( i == END ) i = this->height_ - 1;
...
template<typename T>
Int BlockCyclicMatrix<T>::LocalColOffset( Int j ) const EL_NO_EXCEPT
{ 
    if( j == END ) j = this->width_ - 1;
    return BlockedLength_
...
template<typename T>
Int BlockCyclicMatrix<T>::GlobalRow( Int iLoc ) const EL_NO_EXCEPT
{ 
...
template<typename T>
Int BlockCyclicMatrix<T>::GlobalCol( Int jLoc ) const EL_NO_EXCEPT
{ 
...
// =====================
template<typename T>
bool BlockCyclicMatrix<T>::DiagonalAlignedWith
...
template<typename T>
int BlockCyclicMatrix<T>::DiagonalRoot( Int offset ) const
{
...
template<typename T>
int BlockCyclicMatrix<T>::DiagonalAlign( Int offset ) const
{
...
template<typename T>
void BlockCyclicMatrix<T>::AlignColsWith
( const El::BlockCyclicData& data, bool constrain )
{
...
template<typename T>
void BlockCyclicMatrix<T>::AlignRowsWith
( const El::BlockCyclicData& data, bool constrain )
{
...
template<typename T>
Int BlockCyclicMatrix<T>::NewLocalHeight( Int height ) const
{
    DEBUG_ONLY(CSE cse("BlockCyclicMatrix::NewLocalHeight"))
...
template<typename T>
Int BlockCyclicMatrix<T>::NewLocalWidth( Int width ) const
{
    DEBUG_ONLY(CSE cse("BlockCyclicMatrix::NewLocalWidth"))
    return BlockedLength
           (width,
            this->RowShift(),
            this->BlockWidth(),
...
template<typename T>
void BlockCyclicMatrix<T>::ShallowSwap( BlockCyclicMatrix<T>& A )
{
    this->matrix_.ShallowSwap( A.matrix_ );
...
( const BlockCyclicMatrix<T>& AL, const BlockCyclicMatrix<T>& AR )
{
...
( const BlockCyclicMatrix<T>& AT, const BlockCyclicMatrix<T>& AB )
{
...
( const BlockCyclicMatrix<T>& ATL, const BlockCyclicMatrix<T>& ATR, 
  const BlockCyclicMatrix<T>& ABL, const BlockCyclicMatrix<T>& ABR )
{
...
#ifndef EL_RELEASE
 #define PROTO(T) \
  template class BlockCyclicMatrix<T>;\
...
#else
 #define PROTO(T) template class BlockCyclicMatrix<T>;
#endif
