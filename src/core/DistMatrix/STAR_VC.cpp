...
{ return this->grid_->VCComm(); }
template<typename T>
mpi::Comm DM::PartialRowComm() const EL_NOEXCEPT
{ return this->grid_->MCComm(); }
template<typename T>
mpi::Comm DM::PartialUnionRowComm() const EL_NOEXCEPT
...
template<typename T>
int DM::PartialRowStride() const EL_NOEXCEPT
{ return this->grid_->MCSize(); }
template<typename T>
int DM::PartialUnionRowStride() const EL_NOEXCEPT
