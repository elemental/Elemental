...
template DistMatrix<int,MR,STAR,int>::DistMatrix( const DistMatrix<int,MR,  STAR,int>& A );
...
template DistMatrix<float,MR,STAR,int>::DistMatrix( const DistMatrix<float,MR,  STAR,int>& A );
...
template DistMatrix<double,MR,STAR,int>::DistMatrix( const DistMatrix<double,MR,  STAR,int>& A );
...
template DistMatrix<Complex<float>,MR,STAR,int>::DistMatrix( const DistMatrix<Complex<float>,MR,  STAR,int>& A );
...
template DistMatrix<Complex<double>,MR,STAR,int>::DistMatrix( const DistMatrix<Complex<double>,MR,  STAR,int>& A );
