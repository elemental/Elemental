...
template<typename T>
void
elemental::blas::internal::LocalSymvColAccumulateU
( T alpha, 
...
{
#ifndef RELEASE
    PushCallStack("blas::internal::LocalSymvColAccumulateU");
...
template<typename T>
void
elemental::blas::internal::LocalSymvRowAccumulateU
( T alpha, 
  const DistMatrix<T,MC,  MR>& A,
...
{
#ifndef RELEASE
    PushCallStack("blas::internal::LocalSymvRowAccumulateU");
...
template void elemental::blas::internal::LocalSymvColAccumulateU
( float alpha, 
...
template void elemental::blas::internal::LocalSymvRowAccumulateU
( float alpha, 
  const DistMatrix<float,MC,  MR>& A,
