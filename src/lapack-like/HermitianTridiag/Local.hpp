...
template<typename R> 
void HermitianTridiagL( Matrix<R>& A )
{
#ifndef RELEASE
...
template<typename R> 
void HermitianTridiagU( Matrix<R>& A )
{
#ifndef RELEASE
...
template<typename R>
void HermitianTridiagL( Matrix<Complex<R> >& A, Matrix<Complex<R> >& t )
{
#ifndef RELEASE
    PushCallStack("HermitianTridiagL");
#endif
...
template<typename R>
void HermitianTridiagU( Matrix<Complex<R> >& A, Matrix<Complex<R> >& t )
{
#ifndef RELEASE
    PushCallStack("HermitianTridiagU");
#endif
