...
*/
#ifndef ELEM_HERMITIANTRIDIAG_PANELL_HPP
#define ELEM_HERMITIANTRIDIAG_PANELL_HPP
  ...
  DistMatrix<F,MR,STAR>& W_MR_STAR )
{
    ...
    DEBUG_ONLY(
        CallStackEntry cse("herm_tridiag::PanelL");
...
#endif // ifndef ELEM_HERMITIANTRIDIAG_PANELL_HPP
