...
template<typename T>
void
elemental::lapack::internal::UTUN
( int offset, 
  const DistMatrix<T,MC,MR>& H,
        DistMatrix<T,MC,MR>& A )
{
#ifndef RELEASE
    PushCallStack("lapack::internal::UTUN");
    ...
    while( HBR.Width() < H.Width() )
    {
        ...
        Z_Star_MR.ResizeTo( HPan.Height(), ABR.Width() );
        U_Star_Star.ResizeTo( HPan.Height(), HPan.Height() );
        //--------------------------------------------------------------------//
        HPan_Star_VR = HPan;
        ...
        ( Left, Upper, Normal, NonUnit, (T)1, U_Star_Star, Z_Star_VR );
...
template void elemental::lapack::internal::UTUN
( int offset,
