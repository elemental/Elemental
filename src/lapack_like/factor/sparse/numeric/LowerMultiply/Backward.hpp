...
*/
#pragma once
#ifndef EL_SPARSEDIRECT_NUMERIC_LOWERMULTIPLY_BACKWARD_HPP
#define EL_SPARSEDIRECT_NUMERIC_LOWERMULTIPLY_BACKWARD_HPP
...
{
    DEBUG_ONLY(CSE cse("LowerBackwardMultiply"))
...
#endif // ifndef EL_SPARSEDIRECT_NUMERIC_LOWERMULTIPLY_BACKWARD_HPP
