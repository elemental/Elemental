...
void Usage()
{
    cout << "HErmitian Rank-2K update." << endl << endl;;
    cout << "  Her2k <r> <c> <shape> <trans?> <m> <k> <nb> ";
...
int main( int argc, char* argv[] )
{
    ...
    try
    {
        ...
        TestHer2k<scomplex>( shape, orientation, m, k, (float)3, (float)4,
        ...
        TestHer2k<dcomplex>( shape, orientation, m, k, (double)3, (double)4,
                             testCorrectness, printMatrices, grid           );
        if( rank == 0 )
            cout << endl;
#endif
