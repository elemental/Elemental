      SUBROUTINE XDLARRF( N, D, L, LD, CLSTRT, CLEND,
     $                   W, WGAP, WERR,
...
*  W( CLEND ), XDLARRF finds a new relatively robust representation
...
*           in this case
 ...
 6    CONTINUE
      SAWNAN1 = SAWNAN1 .OR.  XDISNAN( MAX1 )
...
*           in this case
 ...
 7    CONTINUE
      SAWNAN2 = SAWNAN2 .OR.  XDISNAN( MAX2 )
...
*        store new L and D back into DPLUS, LPLUS
         CALL XDCOPY( N, WORK, 1, DPLUS, 1 )
         CALL XDCOPY( N-1, WORK(N+1), 1, LPLUS, 1 )
      ENDIF
