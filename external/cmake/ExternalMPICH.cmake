...
if(MSVC)
  ...
  if(BUILD_SHARED_LIBS)
    ...
    set(MPICH_CXX_LIB ${install_dir}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}mpicxx${CMAKE_SHARED_LIBRARY_SUFFIX})
    set(MPICH_LIB ${install_dir}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}mpi${CMAKE_SHARED_LIBRARY_SUFFIX})
    set(MPICH_PMPI_LIB ${install_dir}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}pmpi${CMAKE_SHARED_LIBRARY_SUFFIX})
  else()
    # TODO: Fortran libraries?
    add_library(libmpicxx STATIC IMPORTED)
    add_library(libmpi STATIC IMPORTED)
    add_library(libpmpi STATIC IMPORTED)
    set(MPICH_CXX_LIB ${install_dir}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}mpicxx${CMAKE_STATIC_LIBRARY_SUFFIX})
    set(MPICH_LIB ${install_dir}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}mpi${CMAKE_STATIC_LIBRARY_SUFFIX})
    set(MPICH_PMPI_LIB ${install_dir}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}pmpi${CMAKE_STATIC_LIBRARY_SUFFIX})
  endif() 
  set_property(TARGET libmpicxx PROPERTY IMPORTED LOCATION ${MPICH_CXX_LIB})
