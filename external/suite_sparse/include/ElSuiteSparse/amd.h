...
int El_amd_order               /* returns AMD_OK, AMD_OK_BUT_JUMBLED,
...
ElSuiteSparse_long El_amd_l_order /* see above for description of arguments */
(
    ElSuiteSparse_long n,
    const ElSuiteSparse_long Ap [ ],
    const ElSuiteSparse_long Ai [ ],
...
(
    ElSuiteSparse_long n,
    ElSuiteSparse_long Pe [ ],
    ElSuiteSparse_long Iw [ ],
    ElSuiteSparse_long Len [ ],
    ElSuiteSparse_long iwlen,
    ElSuiteSparse_long pfree,
    ElSuiteSparse_long Nv [ ],
    ElSuiteSparse_long Next [ ], 
    ElSuiteSparse_long Last [ ],
    ElSuiteSparse_long Head [ ],
    ElSuiteSparse_long Elen [ ],
    ElSuiteSparse_long Degree [ ],
    ElSuiteSparse_long W [ ],
    double Control [ ],
    double Info [ ]
) ;
...
ElSuiteSparse_long El_amd_l_valid
(
    ElSuiteSparse_long n_row,
    ElSuiteSparse_long n_col,
    const ElSuiteSparse_long Ap [ ],
    const ElSuiteSparse_long Ai [ ]
) ;
...
void El_amd_defaults   (double Control [ ]) ;
void El_amd_l_defaults (double Control [ ]) ;

/* amd_control: prints the control settings */
void El_amd_control    (double Control [ ]) ;
void El_amd_l_control  (double Control [ ]) ;

/* amd_info: prints the statistics */
void El_amd_info       (double Info [ ]) ;
void El_amd_l_info     (double Info [ ]) ;

#define EL_AMD_CONTROL 5          /* size of Control array */
#define EL_AMD_INFO 20            /* size of Info array */

/* contents of Control */
#define EL_AMD_DENSE 0       /* "dense" if degree > Control [0] * sqrt (n) */
#define EL_AMD_AGGRESSIVE 1  /* do aggressive absorption if Control [1] != 0 */

/* default Control settings */
#define EL_AMD_DEFAULT_DENSE 10.0   /* default "dense" degree 10*sqrt(n) */
#define EL_AMD_DEFAULT_AGGRESSIVE 1 /* do aggressive absorption by default */

/* contents of Info */
#define EL_AMD_STATUS 0    /* return value of amd_order and amd_l_order */
#define EL_AMD_N 1         /* A is n-by-n */
#define EL_AMD_NZ 2        /* number of nonzeros in A */ 
#define EL_AMD_SYMMETRY 3  /* symmetry of pattern (1 is sym., 0 is unsym.) */
#define EL_AMD_NZDIAG 4    /* # of entries on diagonal */
#define EL_AMD_NZ_A_PLUS_AT 5 /* nz in A+A' */
#define EL_AMD_NDENSE 6       /* number of "dense" rows/columns in A */
#define EL_AMD_MEMORY 7       /* amount of memory used by AMD */
#define EL_AMD_NCMPA 8        /* number of garbage collections in AMD */
#define EL_AMD_LNZ 9          /* approx. nz in L, excluding the diagonal */
#define EL_AMD_NDIV 10        /* number of fl. point divides for LU and LDL' */
#define EL_AMD_NMULTSUBS_LDL 11 /* number of fl. point (*,-) pairs for LDL' */
#define EL_AMD_NMULTSUBS_LU 12  /* number of fl. point (*,-) pairs for LU */
#define EL_AMD_DMAX 13          /* max nz. in any column of L, incl. diagonal */

/* ------------------------------------------------------------------------- */
/* return values of AMD */
/* ------------------------------------------------------------------------- */

#define EL_AMD_OK 0             /* success */
#define EL_AMD_OUT_OF_MEMORY -1 /* malloc failed, or problem too large */
#define EL_AMD_INVALID -2       /* input arguments are not valid */
#define EL_AMD_OK_BUT_JUMBLED 1 /* input matrix is OK for amd_order, but
...
#define EL_AMD_DATE "Oct 10, 2014"
#define EL_AMD_VERSION_CODE(main,sub) ((main) * 1000 + (sub))
#define EL_AMD_MAIN_VERSION 2
#define EL_AMD_SUB_VERSION 4
#define EL_AMD_SUBSUB_VERSION 1
#define EL_AMD_VERSION \
 EL_AMD_VERSION_CODE(EL_AMD_MAIN_VERSION,EL_AMD_SUB_VERSION)
