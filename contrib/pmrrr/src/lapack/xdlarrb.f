      SUBROUTINE XDLARRB( N, D, LLD, IFIRST, ILAST, RTOL1,
...
*  =======
*
*  Given the relatively robust representation(RRR) L D L^T, XDLARRB
...
*
         BACK = WERR( II )
 20      CONTINUE
         NEGCNT = XDLANEG( N, D, LLD, LEFT, PIVMIN, R )
...
*
 ...
 50      CONTINUE
         ...
         NEGCNT = XDLANEG( N, D, LLD, RIGHT, PIVMIN, R )
          IF( NEGCNT.LT.I ) THEN
             RIGHT = RIGHT + BACK
             BACK = TWO*BACK
             GO TO 50
...
*
         NEGCNT = XDLANEG( N, D, LLD, MID, PIVMIN, R )
