...
ElError ElSylvesterPreformedDist_s
( ElInt m, ElDistMatrix_s W, ElDistMatrix_s X );
ElError ElSylvesterPreformedDist_d
( ElInt m, ElDistMatrix_d W, ElDistMatrix_d X );
ElError ElSylvesterPreformedDist_c
( ElInt m, ElDistMatrix_c W, ElDistMatrix_c X );
ElError ElSylvesterPreformedDist_z
