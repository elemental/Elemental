...
/* MultiVec
   -------- */
inline MultiVec<Int>* CReflect( ElMultiVec_i A )
{ return EL_RC(MultiVec<Int>*,A); }

inline MultiVec<float>* CReflect( ElMultiVec_s A )
{ return EL_RC(MultiVec<float>*,A); }

inline MultiVec<double>* CReflect( ElMultiVec_d A )
{ return EL_RC(MultiVec<double>*,A); }

inline MultiVec<Complex<float>>* CReflect( ElMultiVec_c A )
{ return EL_RC(MultiVec<Complex<float>>*,A); }

inline MultiVec<Complex<double>>* CReflect( ElMultiVec_z A )
{ return EL_RC(MultiVec<Complex<double>>*,A); }

inline const MultiVec<Int>* CReflect( ElConstMultiVec_i A )
{ return EL_RC(const MultiVec<Int>*,A); }

inline const MultiVec<float>* CReflect( ElConstMultiVec_s A )
{ return EL_RC(const MultiVec<float>*,A); }

inline const MultiVec<double>* CReflect( ElConstMultiVec_d A )
{ return EL_RC(const MultiVec<double>*,A); }

inline const MultiVec<Complex<float>>* CReflect( ElConstMultiVec_c A )
{ return EL_RC(const MultiVec<Complex<float>>*,A); }

inline const MultiVec<Complex<double>>* CReflect( ElConstMultiVec_z A )
{ return EL_RC(const MultiVec<Complex<double>>*,A); }

inline ElMultiVec_i CReflect( MultiVec<Int>* A )
{ return (ElMultiVec_i)EL_RC(struct ElMultiVec_iDummy*,A); }

inline ElMultiVec_s CReflect( MultiVec<float>* A )
{ return (ElMultiVec_s)EL_RC(struct ElMultiVec_sDummy*,A); }

inline ElMultiVec_d CReflect( MultiVec<double>* A )
{ return (ElMultiVec_d)EL_RC(struct ElMultiVec_dDummy*,A); }

inline ElMultiVec_c CReflect( MultiVec<Complex<float>>* A )
{ return (ElMultiVec_c)EL_RC(struct ElMultiVec_cDummy*,A); }

inline ElMultiVec_z CReflect( MultiVec<Complex<double>>* A )
{ return (ElMultiVec_z)EL_RC(struct ElMultiVec_zDummy*,A); }

inline ElConstMultiVec_i CReflect( const MultiVec<Int>* A )
{ return (ElConstMultiVec_i)EL_RC(const struct ElMultiVec_iDummy*,A); }

inline ElConstMultiVec_s CReflect( const MultiVec<float>* A )
{ return (ElConstMultiVec_s)EL_RC(const struct ElMultiVec_sDummy*,A); }

inline ElConstMultiVec_d CReflect( const MultiVec<double>* A )
{ return (ElConstMultiVec_d)EL_RC(const struct ElMultiVec_dDummy*,A); }

inline ElConstMultiVec_c CReflect( const MultiVec<Complex<float>>* A )
{ return (ElConstMultiVec_c)EL_RC(const struct ElMultiVec_cDummy*,A); }
