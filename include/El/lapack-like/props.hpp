...
//       and point cloud interfaces. 'Pseudospectrum' is strange given that
//       several pseudospectra are implied from the results.
...
// TODO: Remove 'center' from argument list of this version
template<typename F>
