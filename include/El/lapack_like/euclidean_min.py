...
# Minimum length
# --------------
lib.ElMinLength_s.argtypes = \
lib.ElMinLength_d.argtypes = \
lib.ElMinLength_c.argtypes = \
lib.ElMinLength_z.argtypes = \
lib.ElMinLengthDist_s.argtypes = \
lib.ElMinLengthDist_d.argtypes = \
lib.ElMinLengthDist_c.argtypes = \
lib.ElMinLengthDist_z.argtypes = \
lib.ElMinLengthSparse_s.argtypes = \
lib.ElMinLengthSparse_d.argtypes = \
lib.ElMinLengthSparse_c.argtypes = \
lib.ElMinLengthSparse_z.argtypes = \
lib.ElMinLengthDistSparse_s.argtypes = \
lib.ElMinLengthDistSparse_d.argtypes = \
lib.ElMinLengthDistSparse_c.argtypes = \
lib.ElMinLengthDistSparse_z.argtypes = \
  [c_uint,c_void_p,c_void_p,c_void_p]

lib.ElMinLength_s.restype = \
lib.ElMinLength_d.restype = \
lib.ElMinLength_c.restype = \
lib.ElMinLength_z.restype = \
lib.ElMinLengthDist_s.restype = \
lib.ElMinLengthDist_d.restype = \
lib.ElMinLengthDist_c.restype = \
lib.ElMinLengthDist_z.restype = \
lib.ElMinLengthSparse_s.restype = \
lib.ElMinLengthSparse_d.restype = \
lib.ElMinLengthSparse_c.restype = \
lib.ElMinLengthSparse_z.restype = \
lib.ElMinLengthDistSparse_s.restype = \
lib.ElMinLengthDistSparse_d.restype = \
lib.ElMinLengthDistSparse_c.restype = \
lib.ElMinLengthDistSparse_z.restype = \
  c_uint

def MinLength(A,B,orient=NORMAL):
  if A.tag != B.tag:
    raise Exception('Datatypes of A and B must match')
  if type(A) is Matrix:
    if type(B) is not Matrix:
    ...
    X = Matrix(A.tag)
    args = [orient,A.obj,B.obj,X.obj]
    if   A.tag == sTag: lib.ElMinLength_s(*args)
    elif A.tag == dTag: lib.ElMinLength_d(*args)
    elif A.tag == cTag: lib.ElMinLength_c(*args)
    elif A.tag == zTag: lib.ElMinLength_z(*args)
    else: DataExcept()
    return X
  elif type(A) is DistMatrix:
    if type(B) is not DistMatrix:
    ...
    X = DistMatrix(A.tag,MC,MR,A.Grid())
    args = [orient,A.obj,B.obj,X.obj]
    if   A.tag == sTag: lib.ElMinLengthDist_s(*args)
    elif A.tag == dTag: lib.ElMinLengthDist_d(*args)
    elif A.tag == cTag: lib.ElMinLengthDist_c(*args)
    elif A.tag == zTag: lib.ElMinLengthDist_z(*args)
    else: DataExcept()
    return X
  elif type(A) is SparseMatrix:
    if type(B) is not Matrix:
    ...
    X = Matrix(A.tag)
    args = [orient,A.obj,B.obj,X.obj]
    if   A.tag == sTag: lib.ElMinLengthSparse_s(*args)
    elif A.tag == dTag: lib.ElMinLengthSparse_d(*args)
    elif A.tag == cTag: lib.ElMinLengthSparse_c(*args)
    elif A.tag == zTag: lib.ElMinLengthSparse_z(*args)
    else: DataExcept()
    return X
  elif type(A) is DistSparseMatrix:
    if type(B) is not DistMultiVec:
    ...
    X = DistMultiVec(A.tag,A.Comm())
    args = [orient,A.obj,B.obj,X.obj]
    if   A.tag == sTag: lib.ElMinLengthDistSparse_s(*args)
    elif A.tag == dTag: lib.ElMinLengthDistSparse_d(*args)
    elif A.tag == cTag: lib.ElMinLengthDistSparse_c(*args)
    elif A.tag == zTag: lib.ElMinLengthDistSparse_z(*args)
    else: DataExcept()
    return X
  else: TypeExcept()
