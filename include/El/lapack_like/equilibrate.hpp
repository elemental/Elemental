...
void GeomEquil
( Matrix<Field>& A,
  Matrix<Base<Field>>& dRow, Matrix<Base<Field>>& dCol,
  bool progress=false );
template<typename Field>
void GeomEquil
( AbstractDistMatrix<Field>& A,
  AbstractDistMatrix<Base<Field>>& dRow, AbstractDistMatrix<Base<Field>>& dCol,
  bool progress=false );
template<typename Field>
void GeomEquil
( SparseMatrix<Field>& A,
...
void GeomEquil
( DistSparseMatrix<Field>& A,
  DistMultiVec<Base<Field>>& dRow, DistMultiVec<Base<Field>>& dCol,
  bool progress=false );
...
( Matrix<Field>& A, Matrix<Base<Field>>& d, bool progress=false );
template<typename Field>
void SymmetricGeomEquil
( AbstractDistMatrix<Field>& A, AbstractDistMatrix<Base<Field>>& d,
  bool progress=false );
template<typename Field>
void SymmetricGeomEquil
( SparseMatrix<Field>& A, Matrix<Base<Field>>& d, bool progress=false );
template<typename Field>
void SymmetricGeomEquil
( DistSparseMatrix<Field>& A, DistMultiVec<Base<Field>>& d,
  bool progress=false );
...
template<typename Field>
void StackedGeomEquil
( SparseMatrix<Field>& A, SparseMatrix<Field>& B,
  Matrix<Base<Field>>& dRowA,
  Matrix<Base<Field>>& dRowB,
  Matrix<Base<Field>>& dCol,
  bool progress=false );
template<typename Field>
void StackedGeomEquil
( DistSparseMatrix<Field>& A, DistSparseMatrix<Field>& B,
  DistMultiVec<Base<Field>>& dRowA,
  DistMultiVec<Base<Field>>& dRowB,
  DistMultiVec<Base<Field>>& dCol,
  bool progress=false );
