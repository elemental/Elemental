...
template<typename T>
class DistMatrix<T,STAR,STAR,BLOCK_CYCLIC> : public BlockCyclicMatrix<T>
{
public:
    // Typedefs
    // ========
    ...
    typedef DistMatrix<T,STAR,STAR,BLOCK_CYCLIC> type;
    ...
    DistMatrix<T,STAR,STAR,BLOCK_CYCLIC>* Construct
    ( const El::Grid& g, int root ) const override;
    DistMatrix<T,STAR,STAR,BLOCK_CYCLIC>* ConstructTranspose
    ( const El::Grid& g, int root ) const override;
    DistMatrix<T,STAR,STAR,BLOCK_CYCLIC>* ConstructDiagonal
    ( const El::Grid& g, int root ) const override;
