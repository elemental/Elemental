...
template<typename T>
class DistMatrix<T,CIRC,CIRC,BLOCK_CYCLIC> : public BlockCyclicMatrix<T>
{
public:
    // Typedefs
    // ========
    ...
    typedef DistMatrix<T,CIRC,CIRC,BLOCK_CYCLIC> type;
    ...
    DistMatrix<T,CIRC,CIRC,BLOCK_CYCLIC>* Construct
    ( const El::Grid& g, int root ) const override;
    DistMatrix<T,CIRC,CIRC,BLOCK_CYCLIC>* ConstructTranspose
    ( const El::Grid& g, int root ) const override;
    DistMatrix<T,CIRC,CIRC,BLOCK_CYCLIC>* ConstructDiagonal
    ( const El::Grid& g, int root ) const override;
