...
// grid.
template<typename T>
class DistMatrix<T,MC,STAR,BLOCK_CYCLIC> : public BlockCyclicMatrix<T>
{
public:
    typedef AbstractDistMatrix<T> absType;
    typedef BlockCyclicMatrix<T> blockCyclicType;
    typedef DistMatrix<T,MC,STAR,BLOCK_CYCLIC> type;
    ...
    DistMatrix<T,MC,STAR,BLOCK_CYCLIC>* Construct
    ( const El::Grid& g, int root ) const override;
    DistMatrix<T,STAR,MC,BLOCK_CYCLIC>* ConstructTranspose
    ( const El::Grid& g, int root ) const override;
    DistMatrix<T,MC,STAR,BLOCK_CYCLIC>* ConstructDiagonal
    ( const El::Grid& g, int root ) const override;
