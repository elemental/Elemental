...
template<typename T>
class DistMatrix<T,STAR,MR,BLOCK_CYCLIC> : public BlockCyclicMatrix<T>
{
public:
    typedef AbstractDistMatrix<T> absType;
    typedef BlockCyclicMatrix<T> blockCyclicType;
    typedef DistMatrix<T,STAR,MR,BLOCK_CYCLIC> type;
    ...
    DistMatrix<T,STAR,MR,BLOCK_CYCLIC>* Construct
    ( const El::Grid& g, int root ) const override;
    DistMatrix<T,MR,STAR,BLOCK_CYCLIC>* ConstructTranspose
    ( const El::Grid& g, int root ) const override;
    DistMatrix<T,MR,STAR,BLOCK_CYCLIC>* ConstructDiagonal
    ( const El::Grid& g, int root ) const override;
