...
// are coprime.
template<typename T>
class DistMatrix<T,MD,STAR,BLOCK_CYCLIC> : public BlockCyclicMatrix<T>
{
public:
    typedef AbstractDistMatrix<T> absType;
    typedef BlockCyclicMatrix<T> blockCyclicType;
    typedef DistMatrix<T,MD,STAR,BLOCK_CYCLIC> type;
    ...
    DistMatrix<T,MD,STAR,BLOCK_CYCLIC>* Construct
    ( const El::Grid& g, int root ) const override;
    DistMatrix<T,STAR,MD,BLOCK_CYCLIC>* ConstructTranspose
    ( const El::Grid& g, int root ) const override;
