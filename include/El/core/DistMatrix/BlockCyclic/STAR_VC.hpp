...
// distributed.
template<typename T>
class DistMatrix<T,STAR,VC,BLOCK_CYCLIC> : public BlockCyclicMatrix<T>
{
public:
    typedef AbstractDistMatrix<T> absType;
    typedef BlockCyclicMatrix<T> blockCyclicType;
    typedef DistMatrix<T,STAR,VC,BLOCK_CYCLIC> type;
    ...
    DistMatrix<T,STAR,VC,BLOCK_CYCLIC>* Construct
    ( const El::Grid& g, int root ) const override;
    DistMatrix<T,VC,STAR,BLOCK_CYCLIC>* ConstructTranspose
    ( const El::Grid& g, int root ) const override;
