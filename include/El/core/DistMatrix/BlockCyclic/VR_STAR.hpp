...
// distributed.
template<typename T>
class DistMatrix<T,VR,STAR,BLOCK_CYCLIC> : public BlockCyclicMatrix<T>
{
public:
    typedef AbstractDistMatrix<T> absType;
    typedef BlockCyclicMatrix<T> blockCyclicType;
    typedef DistMatrix<T,VR,STAR,BLOCK_CYCLIC> type;
    ...
    DistMatrix<T,VR,STAR,BLOCK_CYCLIC>* Construct
    ( const El::Grid& g, int root ) const override;
    DistMatrix<T,STAR,VR,BLOCK_CYCLIC>* ConstructTranspose
    ( const El::Grid& g, int root ) const override;
