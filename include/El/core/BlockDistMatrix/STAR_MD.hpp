...
*/
#pragma once
#ifndef EL_BLOCKDISTMATRIX_STAR_MD_DECL_HPP
#define EL_BLOCKDISTMATRIX_STAR_MD_DECL_HPP
...
// are coprime.
template<typename T>
class BlockDistMatrix<T,STAR,MD> : public AbstractBlockDistMatrix<T>
{
public:
    // Typedefs
    // ========
    ...
    BlockDistMatrix<T,STAR,MD>* Construct
...
#endif // ifndef EL_BLOCKDISTMATRIX_STAR_MD_DECL_HPP
