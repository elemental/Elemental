...
*/
#pragma once
#ifndef EL_BLOCKDISTMATRIX_STAR_MR_DECL_HPP
#define EL_BLOCKDISTMATRIX_STAR_MR_DECL_HPP
...
template<typename T>
class BlockDistMatrix<T,STAR,MR> : public AbstractBlockDistMatrix<T>
{
public:
    // Typedefs
    // ========
    ...
    BlockDistMatrix<T,STAR,MR>* Construct
...
#endif // ifndef EL_BLOCKDISTMATRIX_STAR_MR_DECL_HPP
