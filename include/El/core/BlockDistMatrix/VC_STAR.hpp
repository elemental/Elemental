...
*/
#pragma once
#ifndef EL_BLOCKDISTMATRIX_VC_STAR_DECL_HPP
#define EL_BLOCKDISTMATRIX_VC_STAR_DECL_HPP
...
// distributed.
template<typename T>
class BlockDistMatrix<T,VC,STAR> : public AbstractBlockDistMatrix<T>
{
public:
    // Typedefs
    // ========
...
#endif // ifndef EL_BLOCKDISTMATRIX_VC_STAR_DECL_HPP
