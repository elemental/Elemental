...
*/
#pragma once
#ifndef EL_BLOCKDISTMATRIX_MC_STAR_DECL_HPP
#define EL_BLOCKDISTMATRIX_MC_STAR_DECL_HPP
...
public:
    ...
    BlockDistMatrix<T,MC,STAR>* Construct
...
#endif // ifndef EL_BLOCKDISTMATRIX_MC_STAR_DECL_HPP
