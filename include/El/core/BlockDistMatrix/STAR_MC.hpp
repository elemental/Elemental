...
*/
#pragma once
#ifndef EL_BLOCKDISTMATRIX_STAR_MC_DECL_HPP
#define EL_BLOCKDISTMATRIX_STAR_MC_DECL_HPP
...
// grid.
template<typename T>
class BlockDistMatrix<T,STAR,MC> : public AbstractBlockDistMatrix<T>
{
public:
    // Typedefs
    // ========
    ...
    BlockDistMatrix<T,STAR,MC>* Construct
...
#endif // ifndef EL_BLOCKDISTMATRIX_STAR_MC_DECL_HPP
