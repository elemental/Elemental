...
template<typename T>
inline void Merge1x2( Matrix<T>& A, Matrix<T>& BL, Matrix<T>& BR )
{
    DEBUG_ONLY(
...
template<typename T>
inline Matrix<T> Merge1x2( Matrix<T>& BL, Matrix<T>& BR )
{
    Matrix<T> A;
    Merge1x2( A, BL, BR );
    return A;
...
template<typename T>
inline Matrix<T> LockedMerge1x2( const Matrix<T>& BL, const Matrix<T>& BR )
{
    Matrix<T> A;
...
inline DistMatrix<T,U,V> Merge1x2( DistMatrix<T,U,V>& BL, DistMatrix<T,U,V>& BR )
{
...
template<typename T,Dist U,Dist V>
inline DistMatrix<T,U,V> LockedMerge1x2
...
template<typename T>
inline void Merge2x1( Matrix<T>& A, Matrix<T>& BT, Matrix<T>& BB )
{
    DEBUG_ONLY(
...
template<typename T>
inline Matrix<T> Merge2x1( Matrix<T>& BT, Matrix<T>& BB )
{
    Matrix<T> A;
    Merge2x1( A, BT, BB );
    return A;
...
template<typename T>
inline Matrix<T> LockedMerge2x1( const Matrix<T>& BT, const Matrix<T>& BB )
{
    Matrix<T> A;
...
template<typename T,Dist U,Dist V>
inline DistMatrix<T,U,V> Merge2x1( DistMatrix<T,U,V>& BT, DistMatrix<T,U,V>& BB )
{
...
template<typename T,Dist U,Dist V>
inline DistMatrix<T,U,V> LockedMerge2x1
...
template<typename T>
inline Matrix<T> LockedMerge2x2
( const Matrix<T>& BTL, const Matrix<T>& BTR,
  const Matrix<T>& BBL, const Matrix<T>& BBR )
{
    Matrix<T> A;
...
template<typename T,Dist U,Dist V>
inline DistMatrix<T,U,V> Merge2x2
...
template<typename T,Dist U,Dist V>
inline DistMatrix<T,U,V> LockedMerge2x2
