...
lib.ElLinearProgramFormSystem_s.restype = c_uint
lib.ElLinearProgramFormSystem_d.argtypes = \
  [c_void_p,c_void_p,c_void_p,
   c_void_p,c_void_p,c_void_p,
   dType,c_void_p,c_void_p]
lib.ElLinearProgramFormSystem_d.restype = c_uint
lib.ElLinearProgramFormSystemDist_s.argtypes = \
  [c_void_p,c_void_p,c_void_p,
   c_void_p,c_void_p,c_void_p,
   sType,c_void_p,c_void_p]
lib.ElLinearProgramFormSystemDist_s.restype = c_uint
lib.ElLinearProgramFormSystemDist_d.argtypes = \
  [c_void_p,c_void_p,c_void_p,
   c_void_p,c_void_p,c_void_p,
   dType,c_void_p,c_void_p]
lib.ElLinearProgramFormSystemDist_d.restype = c_uint
def LinearProgramFormSystem(A,b,c,s,x,l,tau):
  if type(A) is Matrix:
    J = Matrix(A.tag)
    y = Matrix(A.tag)
    args = [A.obj,b.obj,c.obj,s.obj,x.obj,l.obj,tau,J.obj,y.obj]
    if   A.tag == sTag: lib.ElLinearProgramFormSystem_s(*args)
    elif A.tag == dTag: lib.ElLinearProgramFormSystem_d(*args)
    else: DataExcept()
    return J, y
  elif type(A) is DistMatrix:
    J = DistMatrix(A.tag,MC,MR,A.Grid())
    y = DistMatrix(A.tag,MC,MR,A.Grid())
    args = [A.obj,b.obj,c.obj,s.obj,x.obj,l.obj,tau,J.obj,y.obj]
    if   A.tag == sTag: lib.ElLinearProgramFormSystemDist_s(*args)
    elif A.tag == dTag: lib.ElLinearProgramFormSystemDist_d(*args)
    else: DataExcept()
    return J, y
  else: TypeExcept()

lib.ElLinearProgramSolveSystem_s.argtypes = \
  [iType,iType,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p]
lib.ElLinearProgramSolveSystem_s.restype = c_uint
lib.ElLinearProgramSolveSystem_d.argtypes = \
  [iType,iType,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p]
lib.ElLinearProgramSolveSystem_d.restype = c_uint
lib.ElLinearProgramSolveSystemDist_s.argtypes = \
  [iType,iType,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p]
lib.ElLinearProgramSolveSystemDist_s.restype = c_uint
lib.ElLinearProgramSolveSystemDist_d.argtypes = \
  [iType,iType,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p]
lib.ElLinearProgramSolveSystemDist_d.restype = c_uint
def LinearProgramSolveSystem(m,n,J,y):
  if type(J) is Matrix:
    dx = Matrix(J.tag)
    dl = Matrix(J.tag)
    ds = Matrix(J.tag)
    args = [m,n,J.obj,y.obj,ds.obj,dx.obj,dl.obj]
    if   A.tag == sTag: lib.ElLinearProgramSolveSystem_s(*args)
    elif A.tag == dTag: lib.ElLinearProgramSolveSystem_d(*args)
    else: DataExcept()
    return ds, dx, dl
    ...
    args = [m,n,J.obj,y.obj,ds.obj,dx.obj,dl.obj]
    if   J.tag == sTag: lib.ElLinearProgramSolveSystemDist_s(*args)
    elif J.tag == dTag: lib.ElLinearProgramSolveSystemDist_d(*args)
    else: DataExcept()
    return ds, dx, dl
  else: TypeExcept()
...
lib.ElLinearProgramFormAugmentedSystemSparse_s.argtypes = \
  [c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,sType,
   c_void_p,c_void_p]
lib.ElLinearProgramFormAugmentedSystemSparse_s.restype = c_uint
lib.ElLinearProgramFormAugmentedSystemSparse_d.argtypes = \
  [c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,dType,
   c_void_p,c_void_p]
lib.ElLinearProgramFormAugmentedSystemSparse_d.restype = c_uint
lib.ElLinearProgramFormAugmentedSystemDistSparse_s.argtypes = \
  [c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,sType,
   c_void_p,c_void_p]
lib.ElLinearProgramFormAugmentedSystemDistSparse_s.restype = c_uint
lib.ElLinearProgramFormAugmentedSystemDistSparse_d.argtypes = \
  [c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,dType,
   c_void_p,c_void_p]
...
def LinearProgramFormAugmentedSystem(A,b,c,s,x,l,tau):
  if type(A) is Matrix:
    ...
    if   A.tag == sTag: 
      ...
      lib.ElLinearProgramFormAugmentedSystemDistSparse_d(*args)
    else: DataExcept()
    return J, y
  else: TypeExcept()
...
lib.ElLinearProgramFormNormalSystemSparse_s.argtypes = \
  [c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,sType,
   c_void_p,c_void_p]
lib.ElLinearProgramFormNormalSystemSparse_s.restype = c_uint
lib.ElLinearProgramFormNormalSystemSparse_d.argtypes = \
  [c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,dType,
   c_void_p,c_void_p]
lib.ElLinearProgramFormNormalSystemSparse_d.restype = c_uint
lib.ElLinearProgramFormNormalSystemDistSparse_s.argtypes = \
  [c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,sType,
   c_void_p,c_void_p]
lib.ElLinearProgramFormNormalSystemDistSparse_s.restype = c_uint
lib.ElLinearProgramFormNormalSystemDistSparse_d.argtypes = \
  [c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,dType,
   c_void_p,c_void_p]
...
lib.ElLinearProgramSolveNormalSystemSparse_s.argtypes = \
  [c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,sType,
   c_void_p,c_void_p,c_void_p,c_void_p,c_void_p]
lib.ElLinearProgramSolveNormalSystemSparse_s.restype = c_uint
lib.ElLinearProgramSolveNormalSystemSparse_d.argtypes = \
  [c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,dType,
   c_void_p,c_void_p,c_void_p,c_void_p,c_void_p]
lib.ElLinearProgramSolveNormalSystemSparse_d.restype = c_uint
lib.ElLinearProgramSolveNormalSystemDistSparse_s.argtypes = \
  [c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,sType,
   c_void_p,c_void_p,c_void_p,c_void_p,c_void_p]
lib.ElLinearProgramSolveNormalSystemDistSparse_s.restype = c_uint
lib.ElLinearProgramSolveNormalSystemDistSparse_d.argtypes = \
  [c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,dType,
   c_void_p,c_void_p,c_void_p,c_void_p,c_void_p]
...
lib.ElLinearProgramIPFLineSearchSparse_s.argtypes = \
  [c_void_p,c_void_p,c_void_p,
   ...
   c_void_p,c_void_p,c_void_p,
   sType,sType,sType,bType,POINTER(sType)]
lib.ElLinearProgramIPFLineSearchSparse_s.restype = c_uint
lib.ElLinearProgramIPFLineSearchSparse_d.argtypes = \
  [c_void_p,c_void_p,c_void_p,
   c_void_p,c_void_p,c_void_p,
   c_void_p,c_void_p,c_void_p,
   dType,dType,dType,bType,POINTER(dType)]
lib.ElLinearProgramIPFLineSearchSparse_d.restype = c_uint
lib.ElLinearProgramIPFLineSearchDistSparse_s.argtypes = \
  [c_void_p,c_void_p,c_void_p,
   c_void_p,c_void_p,c_void_p,
   c_void_p,c_void_p,c_void_p,
   sType,sType,sType,bType,POINTER(sType)]
lib.ElLinearProgramIPFLineSearchDistSparse_s.restype = c_uint
lib.ElLinearProgramIPFLineSearchDistSparse_d.argtypes = \
  [c_void_p,c_void_p,c_void_p,
   c_void_p,c_void_p,c_void_p,
   c_void_p,c_void_p,c_void_p,
   dType,dType,dType,bType,POINTER(dType)]
...
def LinearProgramIPFLineSearch(A,b,c,s,x,l,ds,dx,dl,
  ...
  if type(A) is Matrix:
    if type(b) != Matrix or type(c) != Matrix or \
       type(x) != Matrix or type(l) != Matrix or type(s) != Matrix or \
    ...
    if type(b) != DistMatrix or type(c) != DistMatrix or \
       type(x) != DistMatrix or type(l) != DistMatrix or \
       type(s) != DistMatrix or \
       type(dx) != DistMatrix or type(dl) != DistMatrix or \
       type(ds) != DistMatrix:
      raise Exception('Expected {b,c,x,l,s,dx,dl,ds} to be of type Matrix')
    alpha = TagToType(A.tag)()
    args = [A.obj,b.obj,c.obj,s.obj,x.obj,l.obj,ds.obj,dx.obj,dl.obj,
    ...
    if type(b) != DistMultiVec or type(c) != DistMultiVec or \
       type(x) != DistMultiVec or type(l) != DistMultiVec or \
       type(s) != DistMultiVec or \
       type(dx) != DistMultiVec or type(dl) != DistMultiVec or \
