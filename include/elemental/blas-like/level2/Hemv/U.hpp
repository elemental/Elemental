...
{
#ifndef RELEASE
    PushCallStack("internal::LocalHemvColAccumulateU");
        ...
        A.Height() != z_MR_STAR.Height() )
    {
        ...
        msg << "Nonconformal LocalHemvColAccumulateU: \n"
    ...
    while( xT_MR_STAR.Height() < x_MR_STAR.Height() )
    {
        ...
        A12.LockedView( A, n0, n0+n1, n1, n2 );
        x1_MC_STAR.LockedView( x_MC_STAR, n0, 0, n1, 1 );
        ...
        D11.AlignWith( A11 );
        //--------------------------------------------------------------------//
        // TODO: The diagonal block updates can be greatly improved
        D11 = A11;
...
{
#ifndef RELEASE
    PushCallStack("internal::LocalHemvRowAccumulateU");
    ...
    {
        std::ostringstream msg;
        msg << "Nonconformal LocalHemvRowAccumulateU: \n"
            << "  A ~ " << A.Height() << " x " << A.Width() << "\n"
    ...
    while( xL_STAR_MR.Width() < x_STAR_MR.Width() )
    {
        ...
        A11.LockedView( A, n0, n0,    n1, n1 );
        A12.LockedView( A, n0, n0+n1, n1, n2 );
        x1_STAR_MC.LockedView( x_STAR_MC, 0, n0, 1, n1 );
