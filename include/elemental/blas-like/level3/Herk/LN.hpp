...
*/
#pragma once
#ifndef BLAS_HERK_LN_HPP
#define BLAS_HERK_LN_HPP
...
template<typename T>
inline void
HerkLN( T alpha, const DistMatrix<T>& A, T beta, DistMatrix<T>& C )
{
#ifndef RELEASE
    PushCallStack("internal::HerkLN");
    if( A.Grid() != C.Grid() )
