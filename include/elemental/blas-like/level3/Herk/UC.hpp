...
*/
#pragma once
#ifndef BLAS_HERK_UC_HPP
#define BLAS_HERK_UC_HPP
...
template<typename T>
inline void
HerkUC( T alpha, const DistMatrix<T>& A, T beta, DistMatrix<T>& C )
{
#ifndef RELEASE
