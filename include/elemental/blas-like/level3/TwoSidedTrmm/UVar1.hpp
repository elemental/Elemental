...
*/
#pragma once
#ifndef ELEM_BLAS_TWOSIDEDTRMM_UVAR1_HPP
#define ELEM_BLAS_TWOSIDEDTRMM_UVAR1_HPP
...
{
#ifndef RELEASE
    CallStackEntry entry("internal::TwoSidedTrmmUVar1");
    if( A.Height() != A.Width() )
...
#endif // ifndef ELEM_BLAS_TWOSIDEDTRMM_UVAR1_HPP
