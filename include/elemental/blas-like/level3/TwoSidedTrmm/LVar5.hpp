...
*/
#pragma once
#ifndef ELEM_BLAS_TWOSIDEDTRMM_LVAR5_HPP
#define ELEM_BLAS_TWOSIDEDTRMM_LVAR5_HPP
...
{
#ifndef RELEASE
    CallStackEntry entry("internal::TwoSidedTrmmLVar5");
    if( A.Height() != A.Width() )
...
#endif // ifndef ELEM_BLAS_TWOSIDEDTRMM_LVAR5_HPP
