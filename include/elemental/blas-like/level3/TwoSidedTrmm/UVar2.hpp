...
*/
#pragma once
#ifndef ELEM_BLAS_TWOSIDEDTRMM_UVAR2_HPP
#define ELEM_BLAS_TWOSIDEDTRMM_UVAR2_HPP
...
{
#ifndef RELEASE
    CallStackEntry entry("internal::TwoSidedTrmmUVar2");
    if( A.Height() != A.Width() )
...
#endif // ifndef ELEM_BLAS_TWOSIDEDTRMM_UVAR2_HPP
