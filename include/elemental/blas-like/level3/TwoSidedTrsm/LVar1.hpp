...
*/
#pragma once
#ifndef ELEM_BLAS_TWOSIDEDTRSM_LVAR1_HPP
#define ELEM_BLAS_TWOSIDEDTRSM_LVAR1_HPP
...
{
#ifndef RELEASE
    CallStackEntry entry("internal::TwoSidedTrsmLVar1");
    if( A.Height() != A.Width() )
...
#endif // ifndef ELEM_BLAS_TWOSIDEDTRSM_LVAR1_HPP
