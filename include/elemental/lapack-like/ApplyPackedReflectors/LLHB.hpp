...
*/
#pragma once
#ifndef ELEM_LAPACK_APPLYPACKEDREFLECTORS_LLHB_HPP
#define ELEM_LAPACK_APPLYPACKEDREFLECTORS_LLHB_HPP
  ...
  const Matrix<F>& H, const Matrix<F>& t, Matrix<F>& A )
{
    ...
    while( HBR.Height() < H.Height() && HBR.Width() < H.Width() )
    {
        ...
        View( ATop, A, 0, 0, HPan.Width(), A.Width() );
...
#endif // ifndef ELEM_LAPACK_APPLYPACKEDREFLECTORS_LLHB_HPP
