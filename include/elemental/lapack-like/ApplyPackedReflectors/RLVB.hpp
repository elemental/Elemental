...
*/
#pragma once
#ifndef ELEM_LAPACK_APPLYPACKEDREFLECTORS_RLVB_HPP
#define ELEM_LAPACK_APPLYPACKEDREFLECTORS_RLVB_HPP
  ...
  const Matrix<F>& H, const Matrix<F>& t, Matrix<F>& A )
{
    ...
    while( HBR.Height() < H.Height() && HBR.Width() < H.Width() )
    {
        ...
        View
        ( ARight, A, 0, A.Width()-HPan.Height(), A.Height(), HPan.Height() );
...
#endif // ifndef ELEM_LAPACK_APPLYPACKEDREFLECTORS_RLVB_HPP
