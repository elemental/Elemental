...
*/
#pragma once
#ifndef LAPACK_APPLYPACKEDREFLECTORS_RLVB_HPP
#define LAPACK_APPLYPACKEDREFLECTORS_RLVB_HPP
...
{
#ifndef RELEASE
    CallStackEntry entry("apply_packed_reflectors::RLVB");
    ...
    while( HBR.Height() < H.Height() && HBR.Width() < H.Width() )
    {
        ...
        Gemm( NORMAL, NORMAL, R(1), ARight, HPanCopy, Z );
        ...
        DistMatrix<R>& A )
{
    ...
    while( HBR.Height() < H.Height() && HBR.Width() < H.Width() )
    {
        ...
        LocalGemm
        ( TRANSPOSE, TRANSPOSE, R(1), HPan_MR_STAR, ARight, ZTrans_STAR_MC );
        ...
        Matrix<Complex<R> >& A )
{
    ...
    while( HBR.Height() < H.Height() && HBR.Width() < H.Width() )
    {
        ...
        Gemm( NORMAL, NORMAL, C(1), ARight, HPanCopy, Z );
        ...
        DistMatrix<Complex<R> >& A )
{
    ...
    while( HBR.Height() < H.Height() && HBR.Width() < H.Width() )
    {
        ...
        HPan_MR_STAR = HPan_VC_STAR;
        LocalGemm( ADJOINT, ADJOINT, C(1), HPan_MR_STAR, ARight, ZAdj_STAR_MC );
...
#endif // ifndef LAPACK_APPLYPACKEDREFLECTORS_RLVB_HPP
