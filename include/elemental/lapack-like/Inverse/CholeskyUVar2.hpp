...
*/
#pragma once
#ifndef ELEM_LAPACK_HPDINVERSE_CHOLESKYUVAR2_HPP
#define ELEM_LAPACK_HPDINVERSE_CHOLESKYUVAR2_HPP
...
{
    DEBUG_ONLY(
        CallStackEntry cse("hpd_inverse::CholeskyUVar2");
        if( A.Height() != A.Width() )
...
#endif // ifndef ELEM_LAPACK_HPDINVERSE_CHOLESKYUVAR2_HPP
