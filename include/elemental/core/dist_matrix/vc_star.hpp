...
class DistMatrix_Dist<VC,STAR,Int> : virtual public DistMatrix_Base<Int>
{
protected:
...
class DistMatrix<T,VC,STAR,Int> : public DistMatrix_Dist<VC,STAR,Int>, public DistMatrix_Type<T,Int>
{
public:
