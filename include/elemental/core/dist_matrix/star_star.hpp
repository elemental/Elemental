...
class DistMatrix_Dist<STAR,STAR,Int> : virtual public DistMatrix_Base<Int>
{
protected:
...
public:
    ...
    void Attach( Int height, Int width, void* buffer, Int ldim, const elem::Grid& grid );
    
    // (Immutable) view of the matrix's buffer (only valid pointer on root)
    void LockedAttach( Int height, Int width, const void* buffer, Int ldim, const elem::Grid& grid );
...
class DistMatrix<T,STAR,STAR,Int> : public DistMatrix_Dist<STAR,STAR,Int>, public DistMatrix_Type<T,Int>
{
public:
