...
class DistMatrix_Dist<MR,STAR,Int> : virtual public DistMatrix_Base<Int>
{
protected:
...
class DistMatrix<T,MR,STAR,Int> : public DistMatrix_Dist<MR,STAR,Int>, public DistMatrix_Type<T,Int>
{
public:
