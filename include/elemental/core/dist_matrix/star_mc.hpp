...
class DistMatrix_Dist<STAR,MC,Int> : virtual public DistMatrix_Base<Int>
{
protected:
...
class DistMatrix<T,STAR,MC,Int> : public DistMatrix_Dist<STAR,MC,Int>, public DistMatrix_Type<T,Int>
{
public:
