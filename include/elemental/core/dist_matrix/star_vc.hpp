...
class DistMatrix_Dist<STAR,VC,Int> : virtual public DistMatrix_Base<Int>
{
protected:
...
class DistMatrix<T,STAR,VC,Int> : public DistMatrix_Dist<STAR,VC,Int>, public DistMatrix_Type<T,Int>
{
public:
