...
*/
#pragma once
#ifndef ELEM_CORE_DISTMATRIX_VR_STAR_DECL_HPP
#define ELEM_CORE_DISTMATRIX_VR_STAR_DECL_HPP
...
public:
    ...
    DistMatrix( const DistMatrix<T,VR,STAR>& A );
    template<Distribution U,Distribution V>
    DistMatrix( const DistMatrix<T,U,V>& A );

    // Move constructor
    DistMatrix( DistMatrix<T,VR,STAR>&& A );
    ...
    const DistMatrix<T,VR,STAR>& operator=( const DistMatrix<T,CIRC,CIRC>& A );

    DistMatrix<T,VR,STAR>& operator=( DistMatrix<T,VR,STAR>&& A );
...
#endif // ifndef ELEM_CORE_DISTMATRIX_VR_STAR_DECL_HPP
