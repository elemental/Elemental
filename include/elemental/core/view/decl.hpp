...
*/
#pragma once
#ifndef ELEM_VIEW_DECL_HPP
#define ELEM_VIEW_DECL_HPP
...
// NOTE: This routine requires that B have 1 x 1 blocks
template<typename T,Dist U,Dist V>
void View( DistMatrix<T,U,V>& A, BlockDistMatrix<T,U,V>& B );
...
// NOTE: This routine requires that B have 1 x 1 blocks
template<typename T,Dist U,Dist V>
void LockedView( DistMatrix<T,U,V>& A, const BlockDistMatrix<T,U,V>& B );
...
#endif // ifndef ELEM_VIEW_DECL_HPP
