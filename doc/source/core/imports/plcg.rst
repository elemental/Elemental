...
`include/elemental/core/imports/plcg.hpp <https://github.com/poulson/Elemental/tree/master/include/elemental/core/imports/plcg.hpp>`_,
while the implementations are in
`external/plcg/parallel_lcg.cpp <https://github.com/poulson/Elemental/tree/master/external/plcg/parallel_lcg.cpp>`_.
