...
# Infeasible IPMs
# ===============
lib.ElIPMCtrlDefault_s.argtypes = \
lib.ElIPMCtrlDefault_d.argtypes = \
  [c_void_p,bType]
class IPMCtrl_s(ctypes.Structure):
  _fields_ = [("primalInit",bType),("dualInit",bType),
              ("infeasibilityTolLogEps",sType),
              ("relativeObjectiveGapTolLogEps",sType),
              ("relativeComplementarityGapTolLogEps",sType),
              ("minDimacsDecreaseRatio",sType),
              ("maxIts",iType),
              ("maxStepRatio",sType),
              ("system",c_uint),
              ("compositeNewton",bType),
              ("compositeNewtonAssumeFeasible",bType),
              ("centralityRule",CFUNCTYPE(sType,sType,sType,sType,sType)),
              ("standardInitShift",bType),
              ("forceSameStep",bType),
              ("solveCtrl",RegSolveCtrl_s),
              ("outerEquil",bType),
              ("twoNormKrylovBasisSize",iType),
              ("progress",bType),
              ("time",bType),
              ("xRegSmallLogEps",sType),
              ("yRegSmallLogEps",sType),
              ("zRegSmallLogEps",sType),
              ("xRegLargeLogEps",sType),
              ("yRegLargeLogEps",sType),
              ("zRegLargeLogEps",sType),
              ("zMinPivotValue",sType),
              ("regIncreaseFactorLogEps",sType),
              ("maxComplementRatio",sType),
              ("softDualityTargets",bType),
              ("lowerTargetRatioLogCompRatio",sType),
              ("upperTargetRatioLogCompRatio",sType),
              ("lowerTargetRatioLogMaxCompRatio",sType),
              ("upperTargetRatioLogMaxCompRatio",sType),
              ("maxRescaleRatioLogEps",sType),
              ("primalNormLowerBound",sType),
              ("primalNormUpperBound",sType),
              ("dualNormLowerBound",sType),
              ("dualNormUpperBound",sType),
              ("backoffScalePower",sType),
              # The following are deprecated.
              ("twoStage",bType),
              ("wSafeMaxNorm",sType),
              ("equilibrateIfSingleStage",bType),
              ("wMaxLimit",sType),
              ("ruizEquilTol",sType),
              ("ruizMaxIter",iType),
              ("diagEquilTol",sType)]
...
class IPMCtrl_d(ctypes.Structure):
  _fields_ = [("primalInit",bType),("dualInit",bType),
              ("infeasibilityTolLogEps",dType),
              ("relativeObjectiveGapTolLogEps",dType),
              ("relativeComplementarityGapTolLogEps",dType),
              ...
              ("progress",bType),
              ("time",bType),
              ("xRegSmallLogEps",dType),
              ("yRegSmallLogEps",dType),
              ("zRegSmallLogEps",dType),
              ("xRegLargeLogEps",dType),
              ("yRegLargeLogEps",dType),
              ("zRegLargeLogEps",dType),
              ("zMinPivotValue",dType),
              ("regIncreaseFactorLogEps",dType),
              ("maxComplementRatio",dType),
              ("softDualityTargets",bType),
              ("lowerTargetRatioLogCompRatio",dType),
              ("upperTargetRatioLogCompRatio",dType),
              ("lowerTargetRatioLogMaxCompRatio",dType),
              ("upperTargetRatioLogMaxCompRatio",dType),
              ("maxRescaleRatioLogEps",dType),
              ("primalNormLowerBound",dType),
              ("primalNormUpperBound",dType),
              ("dualNormLowerBound",dType),
              ("dualNormUpperBound",dType),
              ("backoffScalePower",dType),
              # The following are deprecated.
              ("twoStage",bType),
              ("wSafeMaxNorm",dType),
              ("equilibrateIfSingleStage",bType),
